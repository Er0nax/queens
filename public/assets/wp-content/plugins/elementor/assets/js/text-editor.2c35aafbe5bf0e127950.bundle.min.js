...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[357], {
    1327: (e, t) => {
        ...
        class TextEditor extends elementorModules.frontend.handlers.Base {
            ...
            getDefaultElements() {
                const e = this.getSettings("selectors"), t = this.getSettings("classes"), r = jQuery("<span>", {class: t.dropCap}), p = jQuery("<span>", {class: t.dropCapLetter});
                return r.append(p), {$paragraph: this.$element.find(e.paragraph), $dropCap: r, $dropCapLetter: p}
            }
            ...
            wrapDropCap() {
                ...
                if (!e.length) return;
                const t = e.html().replace(/&nbsp;/g, " "), r = t.match(/^ *([^ ] ?)/);
                if (!r) return;
                const p = r[1], s = p.trim();
                if ("<" === s) return;
