<?php include('../views/matrix/teaser.view.php'); ?>
...
<?php include('../views/matrix/latestFleet.view.php'); ?>

<?php include('../views/matrix/latestNews.view.php'); ?>

<?php include('../views/matrix/team.view.php'); ?>

<?php include('../views/matrix/contact.view.php'); ?>